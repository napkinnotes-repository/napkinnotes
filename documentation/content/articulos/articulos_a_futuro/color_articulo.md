...
Aquí hay otra pequeña trampa. Si pienso en los colores que encontramos en un arcoíris, puedo asociarlos aproximadamente con distintas regiones del espectro visible.

<div style="display: flex; flex-wrap: wrap; gap: 16px; justify-content: center; text-align: center; margin: 20px 0;">

  <div>
    <div>Rojo</div>
    <div style="width: 36px; height: 36px; background: red; border-radius: 6px; margin: 6px auto 0;"></div>
  </div>

  <div>
    <div>Naranja</div>
    <div style="width: 36px; height: 36px; background: orange; border-radius: 6px; margin: 6px auto 0;"></div>
  </div>

  <div>
    <div>Amarillo</div>
    <div style="width: 36px; height: 36px; background: yellow; border-radius: 6px; margin: 6px auto 0;"></div>
  </div>

  <div>
    <div>Verde</div>
    <div style="width: 36px; height: 36px; background: green; border-radius: 6px; margin: 6px auto 0;"></div>
  </div>

  <div>
    <div>Azul</div>
    <div style="width: 36px; height: 36px; background: blue; border-radius: 6px; margin: 6px auto 0;"></div>
  </div>

  <div>
    <div>Violeta</div>
    <div style="width: 36px; height: 36px; background: violet; border-radius: 6px; margin: 6px auto 0;"></div>
  </div>
...
Porque una ilusión también es algo que ocurre. De ilusiones se vive que dice aquel.
...
Y entonces vuelvo allí entre montañas.
...
<ol class="nn-references">
  ...
  <li id="ref-5">
   Smithson, H. E. (2005). Sensory, computational and cognitive components of colour constancy. <em>Philosophical Transactions of the Royal Society B</em>, 363, 1963–1981.
