...
la Luna si no recibían ayuda, y que sólo la haría reaparecer si
...
<figure class="nn-article-figure">
  ...
  <figcaption>
    Figura 2. Corte vertical del sistema Sol-Tierra-Luna. El plano definido por la órbita de la Luna esta inclinado 5.1º con respecto a la eclíptica y rota en un periodo de 18.6 años. El corte de la órbita con la eclíptica define los nodos lunares. Sólo cuando la luna pasa por estos nodos podrá producir un eclipse. 
  </figcaption>
</figure>
...
- **Eclipse total**: la Luna cubre completamente el disco solar, y
  ...
  solar. La totalidad sólo puede observarse desde una estrecha banda en
  la superficie terrestre denominada **franja de totalidad**.

- **Eclipse parcial**: la Luna oculta sólo una parte del Sol, y éste
...
<figure class="nn-article-figure">
  ...
  <figcaption>
    Figura 5. Trazado de rayos de un eclipse total o anular. Dependiendo de si la luna esta en el apogeo o perigeo. La franja de totalidad viene rodeada por una franja donde el eclipse es parcial. En este caso, el nodo lunar se situa en la recta Tierra-Sol. Si el nodo se desvía mucho de esta recta puede haber únicamente franja de parcialidad.  
  </figcaption>
</figure>
...
- El tiempo que tarda la Luna en volver a pasar por el mismo nodo se
  ...
  días. Y como vemos, es más pequeño que el més sinódico por el efecto
  de la precesión.
...
norte. Esta migracción norte-sur o sur-norte provoca que sucesivos
...
- Siempre lleva gafas para el eclipse con estándar ISO $12312-2$: es muy
  ...
  parcialidad del eclipse, aunque el Sol este cubierto al $99\%$, ya que
  puedes no sentir dolor pero en realidad estas quemando tu retina y te
  ...
  ponerselas con la primera luz. Recuerda siempre hay que llevarlas
