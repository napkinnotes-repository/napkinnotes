...
.btn-add:hover {
    ...
    border: 2px solid #b81424 !important;
        ...
        .welcome-screen { background: #ffffff; padding: 10px 0; display: flex; flex-direction: column; gap: 12px; align-items: center; min-height: 300px;}
.btn-choice {
    color: #b81424 !important;
    background: #ffffff;
    border: 2px solid #b81424 !important;
    ...
    for (let y = 0; y < h; y += boxSize) {
        for (let x = 0; x < w; x += boxSize) {
            ...
            if (hasBlackPixel) {
                ...
                ctx.strokeStyle = '#b81424'; currentBoxesCount++;
